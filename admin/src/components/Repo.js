...
const Repo = () => {
  ...
  const createAll = (reposToBecomeProjects) => {
    axios
      ...
      .then((response) => {
        ...
        showAlert({
          title: "Project(s) created",
          message: `Successfully created ${response.data.length} project(s)`,
          variant: "success",
        });
      })
      .catch((error) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        showAlert({
          ...
          message: `Successfully deleted ${response.data.length} project(s)`,
          variant: "success",
        });
      })
      .catch((error) => {
  ...
  return (
    <Box padding={8} background="neutral100">
      {alert && (
        <div
          style={{ position: "absolute", top: "3%", left: "15%", zIndex: 10 }}
        >
          <Alert
          ...
          {repos.map((repo) => {
            ...
            return (
              <Tr key={id}>
                ...
                <Td>
                  <Box paddingTop={2} paddingLeft={4} width="400px">
